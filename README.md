# Projeto - Login e Autenticação

Olá, seja bem-vindo ao meu primeiro projeto utilizando **Cypress + Javascript**!  
Te convido a um **tour pelo processo de desenvolvimento** deste projeto, desde a análise de requisitos até os casos de teste e automação.

## Objetivo do Projeto
Este projeto tem como objetivo reforçar meu aprendizado em QA, estas são algumas das etapas que foram estruturadas:
